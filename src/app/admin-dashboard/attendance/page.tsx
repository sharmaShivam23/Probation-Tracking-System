...
//    async function markAllAttendance(status: "Present" | "Absent") {
//   if (!students.length) {
...
//     await Promise.all(students.map((s) => markAttendance(s?.id, status)));
...
//       {/* Date Picker */}
//       <div className="p flex flex-col mb-5 md:flex-row md:justify-between">
...
//             className="px-4 text-xs sm:text-md h-[40px] bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-md disabled:opacity-50"
//           >
//             Mark All Present
//           </button>
//           <button
...
//             className="px-4 text-xs sm:text-md h-[40px] bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg shadow-md disabled:opacity-50"
//           >
//             Mark All Absent
//           </button>
//         </div>
