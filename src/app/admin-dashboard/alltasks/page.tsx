          ...
          {tasks.map((task) => (
            ...
            >
              <div className="relative z-10">
                ...
                <p className="mt-4 text-gray-200 break-words whitespace-pre-line line-clamp-3">
                  {task?.description || "No description provided."}
                </p>
                ...
                <div className="mt-6 flex flex-col gap-2 text-sm">
                  ...
                  {task?.createdAt && (
                   ...
                   {task?.deadline && (
                     <span className="text-red-600 font-medium">
                       ⏳ Deadline Date {new Date(task.deadline).toLocaleDateString()}
                     </span>
                   )}
                  {task?.deadline && (
                    <span
                      className={`font-medium ${
                        countdowns[task._id] === "Deadline Passed"
                          ? "text-red-500"
                          : "text-green-400"
                      }`}
                    >
                  ...
                  {task?.submissions && (
                    <span className="text-white flex gap-1 font-medium">
                      Total Submissions{" "}
                      <p className="text-green-500">{task.submissions.length}</p>
                    </span>
                  )}
                </div>
              </div>
