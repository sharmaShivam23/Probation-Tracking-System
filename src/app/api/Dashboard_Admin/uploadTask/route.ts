...
// export async function uploadTask(request: NextRequest) {
//   try {
//     await connectDB();
...
//     if (link) {
//       if (
//         !/^https?:\/\/(drive\.google\.com)\/(file\/d\/|open\?id=|uc\?id=|drive\/folders\/)[a-zA-Z0-9_-]+/.test(
//           link
//         )
//       ) {
//         return NextResponse.json(
...
//     //   return NextResponse.json(
//     //     { success: false, message: "Security code must only contain letters, numbers, or @" },
//     //     { status: 400 }
//     //   );
//     // }
...
//     .replace("{{uploadedBy}}", decode.name); 
