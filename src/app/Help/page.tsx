      ...
      <div className="w-full max-w-lg backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full cursor-pointer h-[45px] py-3 text-white bg-gradient-to-r from-red-900 via-gray-900 to-black  font-bold rounded-lg hover:bg-gray-200 transition disabled:opacity-50"
          >
